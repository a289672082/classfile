...
Label:
	...
	__asm {
		pushad
		pushfd
		mov dwX86to64Index,eax
	}

	//是我们要HOOK 的ZW函数
	if (dwHookX86SwitchTo64[dwX86to64Index] != NULL)
	{
		...
		__asm {
			popfd
				...
				lea edx,dwHookX86SwitchTo64
				mov eax,dwX86to64Index
...
{
	byte szCode[7] = {0x64, 0xFF ,0x15 ,0xC0 ,0x00 ,0x00 ,0x00};
