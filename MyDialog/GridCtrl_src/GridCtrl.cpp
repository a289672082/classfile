...
static char* className="MFCGridCtrl";
BOOL CGridCtrl::RegisterWindowClass()
{ 
/*
	GRIDCTRL_CLASSNAME = "MFCGridCtrl";
 
	if (::FindWindowA(GRIDCTRL_CLASSNAME,NULL)!=NULL)
	{
			GRIDCTRL_CLASSNAME = "MFCGridCtrl2";
	}*/
    ...
    if (!(::GetClassInfoA(hInst,  GRIDCTRL_CLASSNAME, &wndcls)))
	{
        ...
        {
			     wndcls.lpszClassName    ="MFCGridCtrl2";
			AfxMessageBox("1");
	...
	if (className =="MFCGridCtrl")
	{
		className ="MFCGridCtrl2";
	}else if (className =="MFCGridCtrl2")
	{
		className ="MFCGridCtrl3";
	}else if (className =="MFCGridCtrl3")
	{
		className ="MFCGridCtrl4";
	}else if (className =="MFCGridCtrl4")
	{
		className ="MFCGridCtrl5";
	}else if (className =="MFCGridCtrl5")
	{
		className ="MFCGridCtrl6";
	}else if (className =="MFCGridCtrl6")
	{
		className ="MFCGridCtrl7";
	}
    return TRUE;
}
...
BOOL CGridCtrl::Create(const RECT& rect, CWnd* pParentWnd, UINT nID, DWORD dwStyle)
{
	...
	{
		AfxMessageBox("ERRO CREATE WINDOWS");
		  return FALSE;
	}
